		...
		<section class="main">
			...
			for($index=0; $index < $indexCount; $index++) {
				if (substr("$dirArray[$index]", 0, 1) != "." and !is_dir("Documents" . $_SESSION['dir'] . "/" . $dirArray[$index]) ){
					...
					?>
				<tr><td><form action="http://ownbox.no-ip.biz/create_folder.php" method="post" name="directory"><input type="text" name="new_dir"><br></form></td>
				<td><a href='http://ownbox.no-ip.biz/download_file.php?file= <?php echo $dirArray2 ?>'>&#8595;</a></td>
				<td><a href='http://ownbox.no-ip.biz/delete_file.php?file= <?php echo $dirArray2 ?>'><span class="deleteX">X</span></a></td>
				</tr>
			</table>
